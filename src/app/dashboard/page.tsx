      ...
      {executionMode && cardState === 'pending' && (
        ...
        >
          ...
          <span style={{ fontSize: 11, fontWeight: 600, color: T.accent }}>
            Execution Mode active — approve to trigger real actions
          </span>
        </div>
      )}

      <div
        style={{ padding: `${py} ${px}`, paddingLeft: leftPad ?? px, cursor: 'pointer' }}
              ...
              <>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 9, marginBottom: 9 }}>
                  <button
                    ...
                    onMouseEnter={e => {
                      ;(e.currentTarget as HTMLElement).style.background = T.successHover
                      ;(e.currentTarget as HTMLElement).style.transform = 'translateY(-1px)'
                    }}
                    onMouseLeave={e => {
                      ;(e.currentTarget as HTMLElement).style.background = T.successBtn
                      ;(e.currentTarget as HTMLElement).style.transform = 'translateY(0)'
                    }}
                  >
